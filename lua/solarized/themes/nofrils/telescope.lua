return function(c, config)
	...
	set_hl("TelescopeSelection", { bg = c.base02 })
	...
	set_hl("TelescopeNormal", { fg = c.base0, bg = c.base03 }, { transparent = config.transparent })
	...
	set_hl("TelescopeBorder", { link = "TelescopeNormal" })
	...
	set_hl("TelescopePreviewMatch", { fg = c.magenta, bg = "NONE", bold = true })
	set_hl("TelescopePreviewLine", { bg = c.base02, bold = true })
end
